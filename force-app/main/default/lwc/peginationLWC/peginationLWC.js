...
import getOpps from '@salesforce/apex/paginationControllerLWC.getOpps';
...
export default class LightningDatatableExample extends LightningElement {
    ...
    @wire(getOpps, {searchKey: '$searchKey', sortBy: '$sortedBy', sortDirection: '$sortedDirection',pageSize :'$pageSize' })
